...
public interface INetworkPolicyListener extends android.os.IInterface {
  ...
  public static abstract class Stub extends android.os.Binder implements
    ...
    private static class Proxy implements android.net.INetworkPolicyListener {
      ...
      public void onUidRulesChanged(int uid, int uidRules) throws android.os.RemoteException {
        ...
        try {
          ...
          mRemote.transact(Stub.TRANSACTION_onUidRulesChanged, _data, null,
      ...
      public void onMeteredIfacesChanged(java.lang.String[] meteredIfaces)
        ...
        try {
          ...
          mRemote.transact(Stub.TRANSACTION_onMeteredIfacesChanged, _data, null,
              android.os.IBinder.FLAG_ONEWAY);
        } finally {
          _data.recycle();
        }
      ...
      public void onRestrictBackgroundChanged(boolean restrictBackground)
        ...
        try {
          ...
          mRemote.transact(Stub.TRANSACTION_onRestrictBackgroundChanged, _data, null,
              android.os.IBinder.FLAG_ONEWAY);
        } finally {
          _data.recycle();
        }
    ...
    static final int TRANSACTION_onUidRulesChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 0);
    static final int TRANSACTION_onMeteredIfacesChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 1);
