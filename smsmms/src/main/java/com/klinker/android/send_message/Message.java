...
public class Message {
    ...
    public static final class Part {
        ...
        public Part(Uri mediaUri, long mediaUriSize, String contentType, String name) {
            this.mediaUri = mediaUri;
            this.contentType = contentType;
            this.name = name;
            this.mediaUriSize = mediaUriSize;
        }
     ...
     * @param size size of the data of given uri
     * @param mimeType is the mimeType of the media
     */
    public void addMedia(Uri uri, long size, String mimeType) {
        this.parts.add(new Part(uri, size, mimeType, null));
    }
     ...
     * @param name is the name of the file
     */
    public void addMedia(Uri uri, long size, String mimeType, String name) {
        this.parts.add(new Part(uri, size, mimeType, name));
    }
