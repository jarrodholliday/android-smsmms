  ...
  public static abstract class Stub extends android.os.Binder implements
    ...
    private static class Proxy implements android.net.IConnectivityManager {
      ...
      public int startUsingNetworkFeature(int networkType, java.lang.String feature,
          android.os.IBinder binder) throws android.os.RemoteException {
        android.os.Parcel _data = android.os.Parcel.obtain();
        android.os.Parcel _reply = android.os.Parcel.obtain();
        int _result;
        try {
      ...
      @Override
      public void requestNetworkTransitionWakelock(java.lang.String forWhom)
          throws android.os.RemoteException {
        android.os.Parcel _data = android.os.Parcel.obtain();
        android.os.Parcel _reply = android.os.Parcel.obtain();
        try {
      ...
      @Override
      public boolean protectVpn(android.os.ParcelFileDescriptor socket)
          throws android.os.RemoteException {
        android.os.Parcel _data = android.os.Parcel.obtain();
        android.os.Parcel _reply = android.os.Parcel.obtain();
        boolean _result;
    ...
    static final int TRANSACTION_setNetworkPreference = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 0);
    static final int TRANSACTION_getNetworkPreference = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 1);
    static final int TRANSACTION_getActiveNetworkInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 2);
    ...
    static final int TRANSACTION_getAllNetworkInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 5);
    static final int TRANSACTION_isNetworkSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 6);
    static final int TRANSACTION_getActiveLinkProperties = (
        android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
    static final int TRANSACTION_getLinkProperties = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 8);
    static final int TRANSACTION_getAllNetworkState = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 9);
    static final int TRANSACTION_getActiveNetworkQuotaInfo = (
        android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
    static final int TRANSACTION_isActiveNetworkMetered = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 11);
    ...
    static final int TRANSACTION_stopUsingNetworkFeature = (
        android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
    static final int TRANSACTION_requestRouteToHost = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 16);
    static final int TRANSACTION_requestRouteToHostAddress = (
        android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
    static final int TRANSACTION_getMobileDataEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 18);
    static final int TRANSACTION_setMobileDataEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 19);
    static final int TRANSACTION_setPolicyDataEnable = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 20);
    ...
    static final int TRANSACTION_getLastTetherError = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 23);
    static final int TRANSACTION_isTetheringSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 24);
    static final int TRANSACTION_getTetherableIfaces = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 25);
    static final int TRANSACTION_getTetheredIfaces = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 26);
    static final int TRANSACTION_getTetheredIfacePairs = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 27);
    static final int TRANSACTION_getTetheringErroredIfaces = (
        android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
    static final int TRANSACTION_getTetherableUsbRegexs = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 29);
    static final int TRANSACTION_getTetherableWifiRegexs = (
        android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
    static final int TRANSACTION_getTetherableBluetoothRegexs = (
        android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
    ...
    static final int TRANSACTION_reportInetCondition = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 34);
    ...
    static final int TRANSACTION_setDataDependency = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 38);
    ...
    static final int TRANSACTION_getLegacyVpnInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 43);
    static final int TRANSACTION_updateLockdownVpn = (android.os.IBinder.FIRST_CALL_TRANSACTION
        + 44);
